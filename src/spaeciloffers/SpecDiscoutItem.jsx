      ...
      <>
         ...
         <div className="bg-white shadow-2xl p-4 rounded-2xl ">
            ...
            <div className="rounded-xl relative p-4 " style={{ backgroundColor: item.bgColor }}>
               ...
               <button className="absolute top-2 laft-2 w-[40px] h-[40px] bg-white rounded-full flex items-center justify-center">
                  <IoMdHeartEmpty />
               </button>

               <button className="absolute top-2 right-2 transform rotate-12 bg-primary text-white py-1 px-6 rounded-md shadow-md">
                  16% OFF
               </button>
...
export default SpecDiscoutItem;