...
import { TbLayoutAlignBottom, TbLayoutGridFilled } from "react-icons/tb";
                              ...
                              <div className="flex flex-col gap-6">
                                 ...
                                 <div className="flex items-center gap-5">
                                    <div className="w-[66px] h-[66px] rounded-2xl flex items-center justify-center bg-[#F8EBE4]">
                                       ...
                                       <img className="mx-auto " src="/shop1-image2.png.png" alt="" />
                                 ...
                                 <div className="flex items-center gap-5">
                                    <div className="w-[66px] h-[66px] rounded-2xl flex items-center justify-center bg-[#F8EBE4]">
                                       ...
                                       <img className="mx-auto " src="/public/shop1-image4.png.png" alt="" />
                  ...
                  {[...Array(6)].map((_, index) => (
                     ...
                     >
                        <div className="rounded-xl relative p-4">
                           <img className="p-3 mx-auto h-[220px] object-cover" src="/public/Figure → classic-image4.png.png" alt="" />
